...
import com.library.rnbanner.config.IndicatorConfig;
import com.library.rnbanner.indicator.Indicator;
import com.library.rnbanner.listener.OnBannerListener;
import com.library.rnbanner.listener.OnPageChangeListener;
import com.library.rnbanner.transformer.MZScaleInTransformer;
import com.library.rnbanner.transformer.ScaleInTransformer;
import com.library.rnbanner.util.BannerLifecycleObserver;
import com.library.rnbanner.util.BannerLifecycleObserverAdapter;
import com.library.rnbanner.util.BannerUtils;
import com.library.rnbanner.util.ScrollSpeedManger;
...
public class Banner<T, BA extends BannerAdapter<T, ? extends RecyclerView.ViewHolder>> extends FrameLayout implements BannerLifecycleObserver {
    ...
    class BannerOnPageChangeCallback extends ViewPager2.OnPageChangeCallback {
        ...
        public void onPageScrollStateChanged(int state) {
            Log.e("TAG11111", "isScrolled: " + isScrolled + " mTempPosition: " + mTempPosition +
                    " getItemCount:  " + getItemCount() + "  getRealCount " + getRealCount());
            //手势滑动中,代码执行滑动中
